export * from './src/ng-fullscreen.module';
export * from './src/common/ng-fullscreen.service';
...
export * from './src/toggle/ng-fullscreen.toggle.module';
export * from './src/toggle/ng-fullscreen.toggle.directive';
