...
declare namespace atlas {
    ...
    export module source {
        ...
        export class DataSource extends Source<DataSourceEvents> {
             ...
             * @param shape The shape, shape id, or feature to be removed
             */
            remove(shape: number | string | Shape | atlas.data.Feature<atlas.data.Geometry, any>): void;
            /**
    ...
    export module math {
         ...
         */
        export function getArea(data: atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any>, areaUnits?: AreaUnits, decimals?: number): number;
        /**
         ...
         */
        export function getConvexHull(data: atlas.data.Position[] | atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any> | atlas.data.FeatureCollection | atlas.data.GeometryCollection | atlas.data.Geometry[] | Array<atlas.data.Feature<atlas.data.Geometry, any>>): atlas.data.Polygon;
        /**
         ...
         * @returns
         */
        export function getClosestPointOnGeometry(pt: atlas.data.Position | atlas.data.Point | atlas.data.Feature<atlas.data.Point, any>, geom: atlas.data.Geometry | atlas.data.Feature<atlas.data.Geometry, any>, units?: string | DistanceUnits, decimals?: number): atlas.data.Feature<atlas.data.Point, {
            distance: number;
        }>;
    }
    ...
    export class Map {
        ...
        /**
         * A workaround to enable mobile pitch gesture on maps.
         * TODO: update when the latest mapbox verison include the supports.
         */
        private _addMobilePitchGesture;
    }
    ...
    export class Shape extends atlas.internal.EventEmitter<ShapeEvents> {
         ...
         */
        constructor(data: atlas.data.Geometry, id?: string, properties?: any);
        /**
    ...
    */
    ...
    export class EventManager {
         ...
         * @param callback The event handler callback.
         */
        addOnce(eventType: "boxzoomstart" | "boxzoomend" | "dragstart" | "drag" | "dragend" | "load" | "movestart" | "move" | "moveend" | "pitchstart" | "pitch" | "pitchend" | "ready" | "render" | "resize" | "rotatestart" | "rotate" | "rotateend" | "styledata" | "tokenacquired" | "zoomstart" | "zoom" | "zoomend", callback: (e: MapEvent) => void): void;
        /**
         ...
         * @param callback The event handler callback.
         */
        remove(eventType: string, callback: (e: void | atlas.layer.Layer | MapMouseEvent | MapTouchEvent | MapMouseWheelEvent | atlas.source.Source) => void): void;
        /**
