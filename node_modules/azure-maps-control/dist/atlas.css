...
.map-copyright > a:hover {
  -webkit-text-fill-color: #0af;
  -moz-text-fill-color: #0af;
  text-decoration: underline;
  text-decoration-color: #0af;
  -moz-text-decoration-color: #0af;
}
.map-copyright.light > * {
  color: black;
...
.azure-maps-control-container.light .azure-maps-control-button.zoom-in:after {
  content: '';
  position: absolute;
  width: 24px;
  left: 4px;
...
.azure-maps-control-container.dark .azure-maps-control-button.zoom-in:after {
  content: '';
  position: absolute;
  width: 24px;
  left: 4px;
