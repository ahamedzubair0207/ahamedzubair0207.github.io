...
@Component({
  selector: 'app-votm-live-order-book-depth-chart',
  templateUrl: './votm-live-order-book-depth-chart.component.html',
  styleUrls: ['./votm-live-order-book-depth-chart.component.scss']
})
export class VotmLiveOrderBookDepthChartComponent implements OnInit {
