...
const routes: Routes = [
  ...
  { path: 'asset/edit/:assetId', component: VotmCloudAssetsCreateComponent,  data: { type: 'Edit' } },
  { path: 'asset/view/:assetId', component: VotmCloudAssetsCreateComponent,  data: { type: 'View' } },
