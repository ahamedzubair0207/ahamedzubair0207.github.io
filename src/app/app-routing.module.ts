...
const routes: Routes = [
  ...
  { path: 'loc/view/:curOrgId/:curOrgName', component: VotmCloudLocationsCreateComponent, data:{type:'View'} },
  { path: 'loc/edit/:curOrgId/:curOrgName', component: VotmCloudLocationsCreateComponent, data:{type:'Edit'} },
