export const MENU_ITEMS: Array<{ id: string, enabled: boolean, url: string, icon: string, name: string}> = [
    ...
    {  id: "organizations", enabled: true, url: "org/home/7A59BDD8-6E1D-48F9-A961-AA60B2918DDE/Parker1", icon: "menu-icon fa fa-building", name: 'Organizations' },
    ...
    // {  id: "locations", enabled: true, url: "loc/home/7a59bdd8-6e1d-48f9-a961-aa60b2918dde/Parker 1", icon: "menu-icon fa fa-location-arrow", name: 'Locations' },
    {  id: "locations", enabled: true, url: "loc/home/7A59BDD8-6E1D-48F9-A961-AA60B2918DDE/Parker1", icon: "menu-icon fa fa-location-arrow", name: 'Locations' },
    {  id: "assets", enabled: true, url: "asset/home/7a59bdd8-6e1d-48f9-a961-aa60b2918dde/Parker 1", icon: "menu-icon fa fa-industry", name: 'Assets' },
