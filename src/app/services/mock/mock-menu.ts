export const MENU_ITEMS: Array<{ id: string, enabled: boolean, url: string, icon: string, name: string}> = [
    ...
    {  id: "organizations", enabled: true, url: "org/home/7a59bdd8-6e1d-48f9-a961-aa60b2918dde/VOTM", icon: "menu-icon icon-org-company", name: 'Organizations' },
    ...
    {  id: "locations", enabled: true, url: "loc/home/7a59bdd8-6e1d-48f9-a961-aa60b2918dde/VOTM", icon: "menu-icon icon-location", name: 'Locations' },
    {  id: "assets", enabled: true, url: "asset/home/7a59bdd8-6e1d-48f9-a961-aa60b2918dde/VOTM", icon: "menu-icon icon-asset-robot", name: 'Assets' },
