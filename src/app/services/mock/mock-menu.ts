export const MENU_ITEMS: Array<{ id: string, enabled: boolean, url: string, icon: string, name: string}> = [
    ...
    {  id: "views", enabled: true, url: "view/home", icon: "fa fa-desktop", name: 'Views' },
    {  id: "organizations", enabled: true, url: "org/home", icon: "fa fa-sitemap", name: 'Organizations' },
    {  id: "locations", enabled: true, url: "loc/home", icon: "fa fa-location-arrow", name: 'Locations' },
